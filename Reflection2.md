...
Most of what I did on this project was making Github a functional platform for the team. I created the new githubs for us all to edit, and put together spaces for testing, reflection, files, and final submittal/editing. I submitted a few code solutions, and while the team liked them, we ultimately preferred other solutions. At the beginning I focused mostly on getting everyone on the team an opportunity to engage, and everyone really contributed. The code collaboration was amazing, and filled with creative solutions thanks to the diversity of the team, and the desire to contribute their own ideas. After ideas were submitted on a day I was not able to attend, we did a code review and picked out the best solutions from all the code proposed. I meshed some of these together for our final submittal.
...
This project was little more difficult to divide it up to small parts for each individual team members, thus we worked individually on it and brought our codes together. I started out by writing the code in a very primitive way and worked my way out with little bugs here and there. The important bug to fix was one, where the code shouldn’t crash if wrong year digit was entered and second, where the user gets to do unlimited searches up until user decides to quit. Our team lead did a good job meshing the codes together and putting together the submitting project.
